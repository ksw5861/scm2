...
function useDateFormat(inputDate) {
  const valueRef = computed(() => (inputDate && typeof inputDate === 'object' && 'value' in inputDate ? inputDate.value : inputDate));
  ...
  <div class="page-wrap font-pretendard">
    ...
    <div class="list-box">
      ...
      <div class="pt-2 border-t border-gray-100 mt-3 flex justify-center">
        <Paginator :first="(page - 1) * rows" :rows="rows" :totalRecords="totalRecords" :rowsPerPageOptions="[10, 20, 50]" template="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink" @page="handlePageChange" />
      </div>
    </div>
