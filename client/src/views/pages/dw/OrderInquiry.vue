...
const orderDetailsMap = {
  ...
  'SO-002': [{ code: 'RB-020', name: '리베리카 원두', spec: '20 kg', unit: 'Box(1)', price: 500000, qty: 1, amount: 500000, approve: '대기' }],
  'SO-003': [{ code: 'RS-010', name: '로부스타 원두', spec: '20 kg', unit: 'Box(1)', price: 500000, qty: 2, amount: 1000000, approve: '반려' }],
  'SO-004': [{ code: 'RS-010', name: '로부스타 원두', spec: '20 kg', unit: 'Box(1)', price: 500000, qty: 2, amount: 1000000, approve: '대기' }],
  'SO-005': [{ code: 'RS-010', name: '로부스타 원두', spec: '20 kg', unit: 'Box(1)', price: 500000, qty: 2, amount: 1000000, approve: '승인' }]
};
...
function exportExcel() {
  /* TODO: 내일 실제 엑셀 유틸 연결 */ alert('엑셀 다운로드 (자리)');
}
function printPDF() {
  /* TODO: 내일 PDF 유틸 연결 */ alert('PDF 출력 (자리)');
}
</script>
...
<template>
  <div class="page-wrap">
    ...
    <div class="split">
      <!-- 좌측 목록 -->
      <div class="list-box">
        <DataTable :value="list" dataKey="orderNo" selectionMode="single" :selection="selectedHeader" @rowSelect="(e) => selectHeader(e.data)" @update:selection="(val) => (selectedHeader = val)" paginator :rows="9">
