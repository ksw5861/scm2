<template>
  <div class="order-register">
    ...
    <div class="summary">
      ...
      <span class="due-date">납기일자: {{ deliveryDate }}</span>
    </div>
    ...
    <DataTable
      ...
      class="order-table"
    >
      <Column field="prod_id" header="제품코드" style="width:130px" />
      <Column field="prod_name" header="제품명" style="width:200px" />
      <Column field="prod_spec" header="규격" style="width:130px" />
      <Column field="prod_unit" header="단위" style="width:100px; text-align:center;" />

      <!-- 제품가격 -->
      <Column field="prod_price" header="제품가격" style="width:130px; text-align:right;">
      ...
      <!-- 주문수량 -->
      <Column header="수량" style="width:90px; text-align:center;">
        <template #body="slotProps">
          <InputNumber
